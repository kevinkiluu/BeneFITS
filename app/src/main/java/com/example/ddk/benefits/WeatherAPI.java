...
public class WeatherAPI {
    ...
    private static final String OPEN_WEATHER_MAP_URL =
            "http://api.openweathermap.org/data/2.5/weather?q=Irvine,USA&units=imperial";

    private static final String OPEN_WEATHER_MAP_API = "2008d99f9430b9f633dde6c83fac3d2a";
