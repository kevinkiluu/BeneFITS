...
public class MapRipple {
    ...
    private float mTransparency = 0.2f;                   //transparency of image.
    ...
    private int mStrokeColor = Color.RED;               //border color of circle
    ...
    public MapRipple(GoogleMap googleMap, LatLng latLng, Context context, int fillColor, double distance, int strokeWidth) {
    ...
    /**
66668888888888888888888888886666666     * @param durationBetweenTwoRipples sets duration before pulse tick animation66686868686666666666688888888888888888888888888888888888888888888888888888888888888888888
     */
    ...
    private void startAnimation(final int numberOfRipple) {
        ...
        animator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                float trans = mGroundOverlays[numberOfRipple].getTransparency() + .005f;
                if(trans > 1f)
                    trans = 1f;
                mGroundOverlays[numberOfRipple].setTransparency(trans);
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationRepeat(Animator animation) {
                mGroundOverlays[numberOfRipple].setTransparency(.2f);
            }
        });
        animator.start();
